...
export class CheckoutExpectations extends AbstractExpectation {
  ...
  showSimpleProductOnCart(productName) {
    if (!productName) throw new Error("showSimpleProductOnCart: productName não fornecido");
  ...
  showVariationProductOnCart(productName) {
    if (!productName) throw new Error("showVariationProductOnCart: productName não fornecido");
